...
export const moviesNewsListSuccess = (data, totalPages, totalResults) => ({ type: MOVIES_NEWS_LIST_SUCCESS, payload: { data, totalPages, totalResults } });
...
export const moviesDiscoverGenresSuccess = (data, totalPages, totalResults) => ({ type: MOVIES_DISCOVER_GENRES_SUCCESS, payload: { data, totalPages, totalResults } });
...
export const moviesPopularListSuccess = (data, totalPages, totalResults) => ({ type: MOVIES_POPULAR_LIST_SUCCESS, payload: { data, totalPages, totalResults } });
...
export const moviesSearchListSuccess = (data, totalPages, totalResults) => ({ type: MOVIES_SEARCH_LIST_SUCCESS, payload: { data, totalPages, totalResults } });
